 ...
 * VALIDATORS
 */
class VLD_Unknown : public Validator		{public:	virtual void operator() (void)	{setResult (true);}																		};
class VLD_Bottom : public Validator			{public:	virtual void operator() (void)	{setResult (descriptionSet[Types::bottom ()].defaultValue () == value ());}	};
...
class VLD_Numeric : public Validator		{public:	virtual void operator() (void)	{float v;	setResult (Property::getNumber (v, value ()));}								};
class VLD_Numeric_Pos : public Validator	{public:	virtual void operator() (void)	{float v;	setResult (Property::getNumber (v, value ()) &&
																											   (v > 0.0f - std::numeric_limits<float>::epsilon ()));}			};
class VLD_Numeric_Neg : public Validator	{public:	virtual void operator() (void)	{float v;	setResult (Property::getNumber (v, value ()) &&
																											   (v < 0.0f));}													};
class VLD_Numeric_Unit : public Validator	{public:	virtual void operator() (void)	{float	v;	setResult (Property::getNumber (v, value (), 0) &&
																											   (v > 0.0f - std::numeric_limits<float>::epsilon ()) &&
...
class VLD_Range : public Validator			{public:	virtual void operator() (void)	{float	v;	setResult (Property::getNumber (v, value (), 0) &&
